...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("The highest bid goes to: " + generalAuction.getHighBid().getBidder()); //get the highest bid, and then get the bidder
        ...
        buyoutAuction.placeBid(new Bid("Dave", 2));
        buyoutAuction.placeBid(new Bid("Ben", 500));
