...
public class Lecture {
    ...
    */
    public int returnVariableFromBlock(int number) {
        ...
        //initialize the results variable before the brackets and reset it inside the brackerts
         int result = 0;
    ...
    */
    public boolean returnSumEveryOtherNumber() {
        ...
        for (int i = 0; i < arrayToLoopThrough.length; i = i + 2) { //increment by 2 to skip every other itemm
